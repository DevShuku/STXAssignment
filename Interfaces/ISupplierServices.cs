...
//Dependency Object should be Interface-Based
    ...
    public class SupplierDAL : ISupplierServices
    {
        List<Supplier> SupplierList = new List<Supplier>
           ...
           */
          /*     new() { SupplierId = 1, SupplierName = "ABC Electronics Co.", Category = "Electronics", ContactName = "Michael Chang", Country = "USA" },
               new() { SupplierId = 2, SupplierName = "XYZ Textiles Ltd.", Category = "Textiles", ContactName = "Haya Emir", Country = "OMAN" },
               new() { SupplierId = 3, SupplierName = "Global Foods Inc.", Category = "Food & Beverage", ContactName="Sophia Lee", Country = "UK" }
